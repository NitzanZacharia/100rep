...
def main():
   ...
   # ... inside main() ...
    ...
    if "falcon-h1" in model_id_lower:
        print(f"[+] Applying Falcon-H1 low-memory fp16 configurations")
    ...
    elif "falcon-7b-instruct" in model_id_lower or "8bit" in model_id_lower:
